$(document).ready(function () {
    var categoryIndexUrl = $("#coursesTable").data("index-url");
    if ($("#coursesTable").length) {
        $("#coursesTable").DataTable({
            ...
            columns: [
                { data: "id", name: "id" },
                { data: "category_name", name: "category_name", defaultContent: "No Category" },
                { data: "yearlevel.name", name: "yearlevel.name", defaultContent: "No Year Level" },
                { data: "course_name", name: "course_name" }, // Display the course name from alias
                {
                    data: "created_at",
                    name: "created_at",
    ...
    $("#addCoursesForm").submit(function (event) {
        ...
        let yearlevelId = $("#yearlevel").val(); // Corrected category selection
        ...
        $.ajax({
            ...
            data: {
                ...
                yearlevel_id: yearlevelId, // Corrected ID field
